...
var import8 = require('../../app/components/hello/hello.component');
var import9 = require('./components/hello/hello.component.ngfactory');
...
var View_AppComponent0 = (function (_super) {
    ...
    View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_4 = import3.createRenderElement(this.renderer, parentRenderNode, 'hello', import3.EMPTY_INLINE_ARRAY, null);
    ...
    View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import8.HelloComponent) && (4 === requestNodeIndex))) {
            return this._HelloComponent_4_3.context;
        }
        return notFoundResult;
    };
    View_AppComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_8 = import3.inlineInterpolate(1, 'Hello ', this.context.name, '');
