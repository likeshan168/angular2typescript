...
import * as import8 from '../../app/components/hello/hello.component';
import * as import9 from './components/hello/hello.component.ngfactory';
...
export class View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  ...
  _text_3:any;
  _el_4:any;
  compView_4:import1.AppView<import8.HelloComponent>;
  _HelloComponent_4_3:import9.Wrapper_HelloComponent;
  _text_5:any;
  /*private*/ _expr_8:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._el_4 = import3.createRenderElement(this.renderer,parentRenderNode,'hello',import3.EMPTY_INLINE_ARRAY,(null as any));
    this.compView_4 = new import9.View_HelloComponent0(this.viewUtils,this,4,this._el_4);
    this._HelloComponent_4_3 = new import9.Wrapper_HelloComponent();
    this.compView_4.create(this._HelloComponent_4_3.context);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import8.HelloComponent) && (4 === requestNodeIndex))) { return this._HelloComponent_4_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this._HelloComponent_4_3.ngDoCheck(this,this._el_4,throwOnChange);
    const currVal_8:any = import3.inlineInterpolate(1,'Hello ',this.context.name,'');
