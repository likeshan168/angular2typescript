...
var import20 = require('@angular/core/src/application_tokens');
var import21 = require('@angular/platform-browser/src/dom/events/dom_events');
var import22 = require('@angular/platform-browser/src/dom/events/key_events');
var import23 = require('@angular/core/src/zone/ng_zone');
var import24 = require('@angular/platform-browser/src/dom/debug/ng_probe');
var import25 = require('@angular/core/src/console');
var import26 = require('@angular/core/src/i18n/tokens');
...
var AppModuleInjector = (function (_super) {
    ...
    function AppModuleInjector(parent) {
        _super.call(this, parent, [import19.AppComponentNgFactory], [import19.AppComponentNgFactory]);
    }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_APP_ID_12", {
        get: function () {
            if ((this.__APP_ID_12 == null)) {
                (this.__APP_ID_12 = import20._appIdRandomProviderFactory());
            }
        ...
        get: function () {
            if ((this.__EVENT_MANAGER_PLUGINS_15 == null)) {
                (this.__EVENT_MANAGER_PLUGINS_15 = [
                    new import21.DomEventsPlugin(),
                    new import22.KeyEventsPlugin(),
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_16", {
        get: function () {
            if ((this.__EventManager_16 == null)) {
                (this.__EventManager_16 = new import11.EventManager(this._EVENT_MANAGER_PLUGINS_15, this.parent.get(import23.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RootRenderer_20", {
        get: function () {
            if ((this.__RootRenderer_20 == null)) {
                (this.__RootRenderer_20 = import24._createConditionalRootRenderer(this._DomRootRenderer_19, this.parent.get(import24.NgProbeToken, null), this.parent.get(import8.NgProbeToken, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AnimationQueue_23", {
        get: function () {
            if ((this.__AnimationQueue_23 == null)) {
                (this.__AnimationQueue_23 = new import15.AnimationQueue(this.parent.get(import23.NgZone)));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._Testability_8 = new import7.Testability(this.parent.get(import23.NgZone));
        this._ApplicationRef__9 = new import8.ApplicationRef_(this.parent.get(import23.NgZone), this.parent.get(import25.Console), this, this._ErrorHandler_6, this, this._ApplicationInitStatus_7, this.parent.get(import7.TestabilityRegistry, null), this._Testability_8);
